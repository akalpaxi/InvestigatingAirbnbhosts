...
library("writexl")
write_xlsx(final_listings_venice, "C:\\Users\\Renos Chatzistavrou\\Desktop\\MA\\Skills dPREP\\Git Bash Docs\\Team6_project_repository\\output\\final_listings_venice.xlsx")