...
temp/listings_merged_clean.csv: src/data-prep/4converting_variable_class.R temp/listings_merged.csv
		R --vanilla < src/data-prep/4converting_variable_class.R
